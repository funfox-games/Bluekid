...
async function start() {
    ...
    document.getElementById("close").innerHTML = `<i class="fa-solid fa-address-card"></i> Profile`;
    ...
    document.getElementById("transferinprogress").innerHTML = `<i class="fa-solid fa-check"></i> Transfer completed!`;
}
