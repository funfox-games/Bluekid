...
function showNotification(type, message) {
    ...
    if (type == 1) {
        ...
        icon.className = "fa-light fa-xl fa-circle-info";
    } else if (type == 2) {
        notif.style.backgroundColor = "#ffd791";
        icon.className = "fa-light fa-xl fa-triangle-exclamation";
    } else if (type == 3) {
        notif.style.backgroundColor = "#ff9191";
        icon.className = "fa-light fa-xl fa-circle-exclamation";
    } else if (type == 4) {
        notif.style.backgroundColor = "#93ff91";
        icon.className = "fa-light fa-xl fa-check";
    }
...
(function () {
    ...
    <i id="notification_close" class="notification_close fa-light fa-lg fa-xmark"></i>`;
