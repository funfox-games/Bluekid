...
async function createKit(title, description, visiblity, canclone) {
    ...
    if (uploadedFile) {
        document.getElementById("createkit").innerHTML = `<i class="fa-light fa-hourglass fa-spin"></i> Uploading cover...`;
    ...
    document.getElementById("createkit").innerHTML = `<i class="fa-light fa-hourglass fa-spin"></i> Waiting..`;
...
onAuthStateChanged(auth, async (user) => {
    ...
    document.getElementById("createkit").addEventListener("click", () => {
        document.getElementById("createkit").innerHTML = `<i class="fa-light fa-hourglass fa-spin"></i> Creating...`;
        ...
        if (MediaUtil.isLimited(title, MediaUtil.MAX_CHAR_NAME)) {
            document.getElementById("createkit").innerHTML = `<i class="fa-light fa-square-plus"></i> Create`;
